...
public class JuegoTopicos extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					JuegoTopicos frame = new JuegoTopicos();
	...
	public JuegoTopicos() {
		...
		btnIniciar.setBounds(175, 404, 127, 59);
		...
		btnSalir.setBounds(27, 402, 127, 63);
		...
		btnButton1.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				{
					JOptionPane.showMessageDialog(null, "Ganaste " + btnButton1.getText(),"Congratulations", JOptionPane.INFORMATION_MESSAGE);
				}
			}
			});
